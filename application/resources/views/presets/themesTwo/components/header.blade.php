            ...
            <div class="row">
                <div class="header-wrapper">
                    ...
                    <div class="menu-wrapper">
                        <ul class="main-menu">
                            @auth
                            <li><a class='{{ Route::is('user.home') ? 'active' : '' }}' href="{{route('user.home')}}">@lang('Dashboard')</a></li>
                            @endauth
                            @foreach($pages as $page)
                            <li><a href="{{route('pages',[$page->slug])}}" aria-current="page" class="{{ Request::url() == url('/').'/'.$page->slug ? 'active' : '' }}">{{__($page->name)}}</a></li>
                            @endforeach
                        </ul>
                    </div>
