...
<head>
    ...
    @if($general->theme_three_base_color && $general->theme_three_secondary_color )
    <link rel="stylesheet" href="{{ asset($activeTemplateTrue.'css/color.php') }}?color={{ $general->theme_three_base_color }}&secondColor={{ $general->theme_three_secondary_color }}">
    @endif
