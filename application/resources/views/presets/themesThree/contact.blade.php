                ...
                <div class="contactus-form">
                    ...
                    <form method="post" action="" class="verify-gcaptcha">
                        ...
                        <div class="row gy-md-4 gy-3">
                            <div class="col-sm-12">
                                <label class="form-label">@lang('Ismingiz')</label>
                            ...
                            <div class="col-sm-12">
                                <label class="form-label">@lang('Qisqacha')</label>
                                <input name="subject" type="text" class="form--control" value="{{old('subject')}}" required>
                            </div>
                            <div class="col-sm-12">
                                <label class="form-label">@lang('Xabar')</label>
                                <textarea class="form--control" name="message">{{old('message')}}</textarea>
                            </div>
                            <x-captcha></x-captcha>
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn--base">
                                   @lang('Yuborish')<i class="fas fa-paper-plane"></i>
