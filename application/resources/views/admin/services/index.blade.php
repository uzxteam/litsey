                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.service.edit',$item->id)}}" title="@lang('Edit')" class="btn btn-sm btn--primary updateService ">
...
<a href="{{route('admin.service.create')}}"  class="btn btn-sm btn--primary">
    @lang('Add Service')</a>
@endpush
